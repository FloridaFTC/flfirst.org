...
const Newsletter2025Aug7 = `# 2025–2026 Newsletter #1: Kickoff

_August 7th, 2025_

Hello there,

My name is AJ Foster, and I'm honored to be the new Program Delivery Partner for _FIRST_ Tech Challenge in Florida. After more than 10 years, our previous leader, Hans Wolf, has stepped back to enjoy some well-deserved retirement. I am extremely grateful for the way Hans cared for and grew this program over the years.

We are one month away from kickoff for the 2025–2026 DECODE™ presented by RTX season. Below is some information focused on kickoff day.

## In-Person Kickoff Events

Most of our leagues will host in-person kickoff gatherings to celebrate the start of the season and watch the game reveal together. Details are still being finalized, so keep an eye on [our website](https://flfirst.org/events) and look for communication from your league leadership soon.

## Virtual Kickoff Broadcast

We will once again host a live broadcast on kickoff day featuring some new and some familiar faces. If you aren't able to attend an in-person kickoff event, I encourage you to watch the broadcast on [https://www.youtube.com/@FIRSTInFlorida](https://www.youtube.com/@FIRSTInFlorida).

## Call for Videos

What advice would you give teams to get started with the new season? We're looking for 30-second (1 minute maximum) videos with your tips. Topics could include how to evaluate game strategy, how to get started with CAD, or anything else relevant to the start of the season. Here are the guidelines:

- 30-second video (1 minute max)
- Film in landscape (for the broadcast)
- Don't include copyrighted music or video
- Post the videos publicly (e.g. YouTube public or unlisted; Google Drive) and send the link to me by Friday, August 29th.

Florida has a [history](https://www.youtube.com/watch?v=iBXi66IgZNc) of [creative](https://www.youtube.com/watch?v=uW7UXB_mEEA) videos. We can't guarantee that all submissions will be used in the show, but I'm excited to see what you come up with.

One last note: the FIRST Tech Challenge Hardship Grant is now available. Please review the criteria [here](https://www.firstinspires.org/robotics/team-grants) and contact me if you would like to apply.
...
`;
const Newsletter2025Aug17 = `# 2025–2026 Newsletter #2: Kickoff Details
...
## In-Person Kickoff Near You

This season, we have seven in-person kickoff gatherings for teams and local volunteers:

- **AeroCoast**: The Doolittle Institute, 1140 John Sims Pkwy E Suite 1, Niceville, FL 32578
- **FUN & South Florida**: Boca Raton High School, 1501 NW 15th Ct, Boca Raton, FL
- **Gulf Coast**: Seminole High School, 8401 131st Street, Seminole, FL 33776
- **Northeast Florida**: The Bolles School, 2264 Bartram Rd, Jacksonville, FL 32207
- **Orlando Robotics**: Lake Highland Preparatory School, 901 N. Highland Ave, Orlando, FL 32803
- **ROBOT**: Location to be announced
- **Space Coast**: Holy Trinity Episcopal Academy, 5625 Holy Trinity Dr, Melbourne, FL 32940

Attending one of these events is the best way to start the season, with opportunities to meet fellow teams, share knowledge, and learn about this year's challenge together. Check [https://flfirst.org/events](https://flfirst.org/events) for the latest event information as it gets published, and look for communication from your local league with instructions for registering and attending.

## Virtual Kickoff

If you can't make it to one of the in-person kickoff sites, we have a live broadcast featuring some new and some familiar faces at [https://www.youtube.com/@FIRSTInFlorida](https://www.youtube.com/@FIRSTInFlorida). The broadcast will begin at 11:30am ET on Saturday, September 6th, and include:

- Welcome message and discussion of the changes to Advancement
- The official game reveal and related videos from FIRST
- Rules commentary from your Florida referees
- Time for Q&A about the game

Join us, won't you?

## Reminder: Call for Videos
...
`;
const Newsletter2025Sep13 = `# 2025–2026 Newsletter #3: Season Calendar

Hello Florida _FIRST_ Tech Challenge,

I hope you enjoyed kickoff, and are excited for the DECODE™ presented by RTX season. This email contains an overview of important dates for the season.
...
- October – January: Leagues host <i>League Meets</i>
...
- February 7: End of the regular season (all <i>League Tournaments</i> complete)
- March 6–7: Florida Championship
- April 29 – May 2: <i>FIRST</i> Championship
...
`;
const Newsletter2025Oct10 = '# 2025-2026 Newsletter #4: Team and Volunteer Training\n\nHello Florida _FIRST_ Tech Challenge,\n\nThis newsletter discusses volunteer training resources, but there’s an important note for teams as well.\n\nTraining resources for mentors and most volunteer roles are now available. This season, _FIRST_ introduced a [new platform](https://training.firstinspires.org/) for training. You can access it directly (using that link), or you can use the **_FIRST_ Training** button in the Volunteer Registration section of your _FIRST_ Dashboard. It uses the same login as your _FIRST_ Dashboard account.\n\nTo get started, you’ll take the **Welcome to _FIRST_** training. Some volunteer roles also require **Data Privacy for Event Volunteers**. After that, you’re free to access any of the volunteer trainings, regardless of whether or not you’ve applied for the role. If you _View Full Catalog_, you can also find training for Mentors. If you’re curious about _FIRST_ LEGO League, _FIRST_ Robotics Competition, or other topics like XRP, you can access those trainings as well. Go wild!\n\n**Teams**: One of the best ways to prepare for an event is to train as a volunteer. Regardless of whether or not you sign up for a role, it’s a great idea to have some of your students and mentors train in a variety of roles. I recommend starting with the **Robot Inspector** training, since this will be the first task you encounter at your first League Meet event. Later in the season, you can take the **Judge** training to understand more about the process before your League Tournament.\n\nGet started at https://training.firstinspires.org/, and have fun.\n\n<p style="font-weight: bold; margin-bottom: 0">\n  AJ Foster\n</p>\n\n<p style="font-size: 0.75em">\n  Program Deliver Partner · Florida<br />\n  Global Key · Technology<br />\n  <i>FIRST</i> Tech Challenge\n</p>\n';
const Newsletter2025Oct26 = '# 2025–2026 Newsletter #5: Preparing for League Meets\n\nHello Florida _FIRST_ Tech Challenge,\n\nAs we approach the start of League Meet events, this email contains important things to consider.\n\n**1. Please Update FTC Apps to Version 11**\n\nVersion 11.0 of the [applications](https://github.com/FIRST-Tech-Challenge/FtcRobotController) you use to control your robot has important improvements that will help you and event-day volunteers. Although _FIRST_ does not require a specific minimum version of this software, please update to version 11.0 to get these improvements.\n\n**2. No More Field Inspection**\n\nPreviously, inspection was split between _Robot Inspection_ and _Field Inspection_. This season, there is only one unified _Inspection_ process. Review the [Inspection Checklist](https://ftc-resources.firstinspires.org/ftc/event/inspection-check) to understand where your inspectors will focus, and — if you want to be extra prepared — consider taking the Inspector training on [training.firstinspires.org](http://training.firstinspires.org/).\n\n**3. Practice Matches**\n\nIn the absence of Field Inspection, many events will offer _Practice Matches_ as an opportunity to practice the full match process (from queueing to reset) at the beginning of your event. Read [Section 13.5](https://ftc-resources.firstinspires.org/ftc/game/manual-13) of the Competition Manual for more information, and — if you want to be extra prepared — read the _Practice Matches_ section of the [Field Operations Guide](https://ftc-resources.firstinspires.org/ftc/event/field-ops-guide) to understand more about the process.\n\nSome important items to remember:\n\n- Not all events are able to offer Practice Matches.\n- Practice Matches can be scheduled or open, and there are different processes for each.\n- Practice Matches may happen at the same time as inspection and (later in the season) judging interviews. Teams may not be able to participate in their scheduled match.\n- Your event may provide a “filler line” for teams to fill open spots in scheduled matches (or to fill all slots in open matches).\n\nThis is a new process, so please be patient with your event-day volunteers.\n\nSee you at an event soon!\n\n<p style="font-weight: bold; margin-bottom: 0">\n  AJ Foster\n</p>\n\n<p style="font-size: 0.75em">\n  Program Deliver Partner · Florida<br />\n  Global Key · Technology<br />\n  <i>FIRST</i> Tech Challenge\n</p>\n';
const Newsletter2025Dec01 = `# 2025–2026 Newsletter #6: Future Florida Championships

Hello Florida _FIRST_ Tech Challenge,

Quick reminder: [Dean’s List Award](https://www.firstinspires.org/robotics/ftc/deans-list) nominations are due by December 15th.

The rest of this email relates to future seasons of the Florida Championship event and ways you can help. **Short version**: we’re looking for potential venues, and we’re looking for sponsorship opportunities.

As you may know, the Florida Championship event has been at the AdventHealth Fieldhouse in Winter Haven for several years. (We’ll be back on March 6–7, 2026 for this season's event.) The venue, staff, and financial support from _Visit Central Florida_ have been incredible. This is the final year of our standing agreement with them, which means it’s time to consider our options for March 2027 and beyond.

While there are many things to love about the Fieldhouse, it’s starting to get a little tight on seating and pit space. Our program continues to grow — we’ve reached 256 teams! — and I’d love the option to expand the Florida Championship to more teams in the future.

So what can you do to help?

1. If you know of an appropriately-sized venue — and better yet, if you have contacts — please reach out to me. Remember that we have some notable requirements (it’s a dual-division event with 4 fields and at least 56 teams), so even an oversized gymnasium usually isn’t enough space. If you contact me, I’ll be happy to talk through the requirements with you. Cost will be a driving factor in many decisions.
2. If you know of anyone who might be interested in sponsoring the Florida Championship, please reach out to me.

Some of our past Florida Championship locations have come from connections made by viewers like you.

Thank you for your help. See you at an event soon!
...
`;
const Newsletter2025Dec07 = '# 2025–2026 Newsletter #7: Florida Championship (Ways to Attend)\n\nHello Florida _FIRST_ Tech Challenge teams,\n\n_The short version_: The Florida Championship Volunteer T-Shirt Contest and Lottery are back. If you’re interested, read the requirements below.\n\n\\~\\~\\~\n\nWe’re almost finished with events in 2025. That means it’s time to start looking forward to our League Tournaments and the Florida Championship event. This email contains information about the different ways to attend the Florida Championship.\n\n**About Advancement**\n\n56 teams will join us at the Florida Championship on March 6–7, 2026 at the AdventHealth Fieldhouse in Winter Haven. 54 of those teams will advance from our eight League Tournament events based on the [new advancement model](https://community.firstinspires.org/advancement-first-championship-update) introduced by _FIRST_ this season. (The exact number of teams advancing from each league will be announced in January.) One additional team will receive an invitation as the winner of the Volunteer T-Shirt Contest (more on that below). Finally, one additional team will receive an invitation from the team lottery (more on that too).\n\nThis season, we are fortunate to advance **9 teams** from the Florida Championship to the _FIRST_ Championship in Houston, TX, and an **additional 13 teams** to Premier Events around the world.\n\n**Volunteer T-Shirt Contest**\n\nThis season, I’m pleased to continue the Volunteer T-Shirt Contest for teams. A design selected from team submissions will be worn by our Florida Championship volunteers, and the team that submitted the winning design will receive an invitation to the Florida Championship. This is a great chance to express your creativity and lock in an automatic invitation.\n\nSubmissions must adhere to the following guidelines:\n\n- Use [this form](https://docs.google.com/forms/d/e/1FAIpQLSfK7dl8uHAvunv-E3gKvaYTy68Ew-fQH3MXohlim8UYN8ArOA/viewform?usp=header) to submit your design.\n- Submitted design must be digital (no scans or photos).\n- Uploaded file should be high-resolution or vector (JPEG, PNG, or SVG).\n- Design should use a single foreground color.\n- Design should include the text: "Florida Championship 2026"\n- Design should incorporate the official DECODE™ presented by RTX logo (available [here](https://info.firstinspires.org/free-season-content)).\n\nSubmissions are due by 11:59pm ET on Saturday, January 3, 2026. I can’t wait to see what everyone comes up with!\n\n**Florida Championship Lottery**\n\nI’m also pleased to continue the lottery program for teams that have not recently attended the Florida Championship. Our final opening is filled with a randomly selected team, weighted by the number of seasons since their last appearance at the event.\n\nIf you are interested in participating in the team lottery, please fill out [this form](https://docs.google.com/forms/d/e/1FAIpQLScNxe6ZjdTZIBHb8D16u8TwuRir813BVPRpDV10FOhqUUvJag/viewform?usp=header) by 11:59pm ET on Saturday, January 3, 2026.\n\n\\~\\~\\~\n\nI hope you have a relaxing new year and return excited to finish DECODE™ presented by RTX regular season play.\n\n<p style="font-weight: bold; margin-bottom: 0">\n  AJ Foster\n</p>\n\n<p style="font-size: 0.75em">\n  Program Deliver Partner · Florida<br />\n  Global Key · Technology<br />\n  <i>FIRST</i> Tech Challenge\n</p>\n';
const Newsletter2026Jan21 = '# 2025–2026 Newsletter #8: Florida Championship (Advancement Counts & Call for Volunteers)\n\nHello Florida _FIRST_ Tech Challenge,\n\n_The short version_: This email contains the number of teams advancing from each of our eight League Tournament events to the Florida Championship. If you or someone you know would like to volunteer at the event, please [join us](https://my.firstinspires.org/ExpressVolunteer/landing-page/73e633a7-8ba1-11f0-8142-00505699b848)!\n\n\\~\\~\\~\n\n**Advancement Counts**\n\nI’m pleased to share that the Florida Championship will grow to **60 teams** this year. All of your outreach efforts have led to incredible growth over the past few years, and we’re doing our best to host as many teams as possible at this event.\n\nHere is the breakdown of advancement from each League Tournament event:\n\n- AeroCoast: **6**\n- FIRST United Network: **6**\n- Gulf Coast: **10**\n- Northeast Florida: **8**\n- Orlando Robotics: **8**\n- ROBOT: **6**\n- South Florida: **9**\n- Space Coast: **5**\n\nThese teams will join the winner of our Volunteer T-shirt Contest and the Florida Championship lottery described in the previous newsletter.\n\nAs a reminder, _FIRST_ announced a [new advancement model](https://community.firstinspires.org/advancement-first-championship-update) this season. You can read about it in [Section 4 of the Competition Manual](https://ftc-resources.firstinspires.org/ftc/game/manual-04).\n\n**Call for Volunteers**\n\nWe would love for you to join us as a volunteer at the Florida Championship. If you are a coach, mentor, or parent on a team...\n\n- Consider joining us as a **Judge** to see presentations from our top teams and learn what might be effective for your team in the future.\n- Consider joining us as an **Inspector** to get up close with the robots and hear how they work.\n- Or join us in any of the other open roles to help us make this celebration come together.\n\nUse [this signup link](https://my.firstinspires.org/ExpressVolunteer/landing-page/73e633a7-8ba1-11f0-8142-00505699b848) to get started. We can’t run this event without your help, and you’ll join a lovely community of fellow volunteers.\n\nWe also couldn’t run this event without the help of sponsors. I’d like to recognize Infinity Insurance Agency for sponsoring the 2026 Florida Championship and the Florida FIRST Tech Challenge program in general. Infinity Insurance Agency is proud to serve the community by offering affordable and customizable auto insurance solutions for families and small business owners. You can read more about them [here](https://www.infinityauto.com/?utm_source=client_website&utm_medium=newsletter&utm_campaign=firsttechflorida).\n\n\\~\\~\\~\n\nSee you soon,\n\n<p style="font-weight: bold; margin-bottom: 0">\n  AJ Foster\n</p>\n\n<p style="font-size: 0.75em">\n  Program Deliver Partner · Florida<br />\n  Global Key · Technology<br />\n  <i>FIRST</i> Tech Challenge\n</p>\n';
const Newsletter2026Feb14 = `# 2025–2026 Newsletter #9: Florida Championship (Teams & Times)
...
Congratulations to the following teams who will join us at the Florida Championship:

|  Team | Name                       | League |
| ----: | -------------------------- | ------ |
|   506 | Pandara                    | GC     |
|   641 | Tater Scots                | FN     |
|  2845 | Team Duct Tape             | RO     |
|  3846 | Maelstrom                  | RO     |
|  3888 | Greased Lightning          | SF     |
|  4228 | Gears Of Other Dimensions  | SC     |
|  4361 | TurBOCAts                  | FN     |
|  6433 | Neutrinos                  | RO     |
|  7477 | Super 7                    | SC     |
|  7592 | Roarbots                   | SC     |
|  9800 | TechnoSaints HyperShock    | OR     |
|  9986 | Eaglebotics Navy           | SF     |
| 10179 | Tech Turtles               | AC     |
| 11172 | Static Discharge           | NE     |
| 13093 | Golden Fish                | GC     |
| 14707 | Zero Logic                 | AC     |
| 14725 | Java the Hutts             | GC     |
| 15006 | Nerdvana                   | GC     |
| 15297 | Legacy                     | AC     |
| 16249 | Excaliper                  | OR     |
| 16290 | Z.I.P Ties                 | SC     |
| 16312 | Sandman                    | NE     |
| 16333 | Mechatrons - Pahokee High  | FN     |
| 16391 | Rising Ninjas              | SF     |
| 16465 | Servo Stallions            | NE     |
| 16484 | ROBOCANES                  | SF     |
| 17288 | Rubber Bandits             | OR     |
| 18147 | The Imposters              | AC     |
| 18258 | Doomba                     | SC     |
| 18317 | Steel Eels                 | NE     |
| 18385 | Mecha Knights              | NE     |
| 18699 | The Purple Axolotls        | AC     |
| 19954 | Mario's Mechanics          | RO     |
| 20022 | RoBOCAts                   | FN     |
| 20344 | Cattlebots                 | OR     |
| 20357 | Tocoi Creek Los Toros Loco | NE     |
| 21882 | Cyber Spartans             | SF     |
| 21922 | ΔΨΝΑΜΙCΣ (Dynamics)        | FN     |
| 22012 | Loose Screws               | OR     |
| 22127 | Mischievous Mechanics      | NE     |
| 23571 | jEdison Knights            | GC     |
| 23979 | Ultronic                   | GC     |
| 24008 | Optimus PINE               | FN     |
| 24085 | Short Circuit              | OR     |
| 24702 | Voltaris                   | GC     |
| 25002 | Cat Batch                  | RO     |
| 26038 | Catastrophic RAMifications | AC     |
| 26588 | Midnight                   | RO     |
| 27031 | Shazam!                    | SF     |
| 27188 | Fractal Fusion             | OR     |
| 27991 | IMAGenius                  | GC     |
| 29692 | Mysteria                   | GC     |
| 30342 | Iron Claw                  | AC     |
| 30435 | Klutch Robotics            | SF     |
| 30694 | Bots4Life                  | GC     |
| 31000 | VANTA                      | OR     |
| 31132 | HorsePower                 | NE     |
| 31791 | Joules of Wisdom           | SF     |
| 32013 | Ninja Stars                | SF     |
| 32385 | MIGHTY MOJO                | GC     |

This includes our lottery recipients and the Volunteer T-Shirt contest winner, **21882 Cyber Spartans**. I’m excited to see their design in person at the event!

**2. How to Watch**

Everyone in the Florida _FIRST_ Tech Challenge community is invited to attend the Florida Championship on March 6–7. We’ll begin qualification matches after 4pm ET on Friday afternoon, and continue the festivities starting at Saturday morning around 8am ET.

If you can’t join us in person, you can watch our live streams for each division. They’ll broadcast the same stream during ceremonies, awards, and finals; and show each individual division during qualification matches. Find all four streams (Lawrence & Scott Division, Day 1 & 2) here: https://www.youtube.com/playlist?list=PLvY2mfgD-92H_eqvZ1PnIFFsHUhYwZbRb.

**3. Call for Volunteers**

If you want to be a part of the fun, we are looking for additional Judges and several other roles. Judging will take place via remote interviews on Saturday, February 28th and the evening of Tuesday, March 3rd. Follow-ups and deliberation occur Friday evening on March 6th and Saturday March 7th. You can sign up here (link expired).

\\~\\~\\~

Congratulations again to all of our teams for their hard work this season. I’d like to close with another Thank You to our Lawrence Division and program sponsor, [Infinity Insurance Agency](https://www.infinityauto.com/?utm_source=client_website&utm_medium=newsletter&utm_campaign=firsttechflorida). Besides sponsoring a division at the event, they also provided funding for the trophies we’ll give away this year. Thank you!
...
function Newsletter() {
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col mx-auto gap-4", children: [
    /* @__PURE__ */ jsx(
      MarkdownPost,
      {
        content: Newsletter2026Mar09,
        summary: Newsletter2026Mar09Summary
      }
    ),
    /* @__PURE__ */ jsx(
      MarkdownPost,
    ...
    /* @__PURE__ */ jsx(
      MarkdownPost,
      {
        content: Newsletter2025Aug7,
        summary: Newsletter2025Aug7Summary
      }
    ),
    /* @__PURE__ */ jsx(
      MarkdownPost,
...
const cover = 'The Florida <a href="https://www.firstinspires.org/programs/ftc/"><i>FIRST</i> Tech Challenge</a> program is a sport for engineers. However, _FIRST_ is more than building robots. It enables middle and high school students to apply the skills they are learning it school to a sports-style robotics competition.\n\n*FIRST* Tech Challenge teams (grades 6-12) are challenged to design, build, program, and operate robots to compete in a head-to-head challenge in an alliance/team format. The robot kit is reusable from year to year and can be coded using a variety of levels of Java-based programming. Participants are eligible to apply for **$80M+** in college scholarships.\n\nThe Florida _FIRST_ Tech Challenge program includes **256+** teams from Pensacola to Miami. Florida is organized into [leagues](/leagues) that compete in local events between October and earlier February with some teams qualifying for the Florida Championship in early March.\n\nFor more information about the program, check out [this overview](https://docs.flfirst.org/overview/) or contact:\n\n<strong>AJ Foster</strong><br>\nProgram Delivery Partner<br>\n[afoster@firstpartners.org](mailto:afoster@firstpartners.org)\n';
const meta$1 = () => {
  return [
